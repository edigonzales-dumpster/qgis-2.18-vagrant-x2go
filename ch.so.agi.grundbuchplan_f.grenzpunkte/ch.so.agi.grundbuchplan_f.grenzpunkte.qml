...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="3000" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <rules key="{a11a3863-f88d-4b63-b73f-7e12351a5422}">
      <rule filter="punktzeichen_txt = 'Stein'" key="{68fb69e6-2286-4701-953d-bede058d94a4}" label="Stein">
        ...
        <rule scalemaxdenom="750" key="{2447bd6f-fe2d-4e91-82fc-f80cb9085295}" scalemindenom="300" label="1:500">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{21c2d9a2-be79-4316-8b34-78a8f4d26b20}" symbol="1" label="Stein.gueltig"/>
        </rule>
        <rule scalemaxdenom="1250" key="{c79558ba-193d-4f19-b793-96193a81edf1}" scalemindenom="750" label="1:1000">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{e3a3ed9d-a20c-4b29-a658-9caa637e106e}" symbol="2" label="Stein.gueltig"/>
        </rule>
        <rule scalemaxdenom="3000" key="{30d4cbb5-e2c5-4926-9217-2d2b386e52a8}" scalemindenom="1250" label="1:2000">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{a5eaa0de-0f52-4a65-897f-e4f95662f201}" symbol="3" label="Stein.gueltig"/>
        </rule>
      </rule>
      <rule filter="punktzeichen_txt = 'Kunststoffzeichen'" key="{ef21a8fa-53ce-422e-a0f0-2bff29647b02}" label="Kunststoffzeichen">
        <rule scalemaxdenom="300" key="{84a8c26b-19e3-4ab3-96a4-371e9b035369}" scalemindenom="1" label="1:250">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{4842b5f4-857b-4fa2-b3dc-9a51a16fdac7}" symbol="4" label="Kunststoffzeichen.gueltig"/>
        </rule>
        <rule scalemaxdenom="750" key="{181da211-d33e-497e-a5c0-800e135ca25b}" scalemindenom="300" label="1:500">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{15cd6258-2bf4-4b57-b72d-97602a200a53}" symbol="5" label="Kunststoffzeichen.gueltig"/>
        </rule>
        <rule scalemaxdenom="1250" key="{05360e5f-00f0-4fc9-8962-3d67eff45bca}" scalemindenom="750" label="1:1000">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{019d2c2c-bbd3-4907-aaaf-32086012e777}" symbol="6" label="Kunststoffzeichen.gueltig"/>
        </rule>
        <rule scalemaxdenom="3000" key="{7bb45534-3f27-4024-8032-c85136d7200d}" scalemindenom="1250" label="1:2000">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{01167179-25f5-41ca-b33b-87455866918e}" symbol="7" label="Kunststoffzeichen.gueltig"/>
        </rule>
      </rule>
      <rule filter="punktzeichen_txt = 'Bolzen'" key="{434c2560-e011-4481-a1b4-3ee333939a54}" label="Bolzen">
        <rule scalemaxdenom="300" key="{04320e84-b827-4a2f-9a21-03f7604c554e}" scalemindenom="1" label="1:250">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{e105fb67-fc06-4fc4-8970-9a180b1f8ff3}" symbol="8" label="Bolzen.gueltig"/>
        </rule>
        <rule scalemaxdenom="750" key="{b9d006d8-fac4-4879-a69f-93ad08b95fea}" scalemindenom="300" label="1:500">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{bcea1bed-5b82-49fa-8255-f976b57ccbb2}" symbol="9" label="Bolzen.gueltig"/>
        </rule>
        <rule scalemaxdenom="1250" key="{99649be3-2d91-49bd-b225-9fd98d1b8025}" scalemindenom="750" label="1:1000">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{9bc68dec-72f1-4399-a6b0-ac8acbe2fe0d}" symbol="10" label="Bolzen.gueltig"/>
        </rule>
        <rule scalemaxdenom="3000" key="{fa640163-405a-46c5-beec-52160c027f80}" scalemindenom="1250" label="1:2000">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{963e7231-bbbf-4049-a35d-ee13a90661ac}" symbol="11" label="Bolzen.gueltig"/>
        </rule>
      </rule>
      <rule filter="punktzeichen_txt = 'Rohr'" key="{ca141fca-4ea9-4999-bb35-79b960768f19}" label="Rohr">
        <rule scalemaxdenom="300" key="{d00cac68-353c-4c28-9a3b-122ddaae5cc3}" scalemindenom="1" label="1:250">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{feb09316-cb04-4089-af45-45b68fff4f66}" symbol="12" label="Rohr.gueltig"/>
        </rule>
        <rule scalemaxdenom="750" key="{bd64616a-a615-4af5-8921-e439463f2285}" scalemindenom="300" label="1:500">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{3f7261e1-059d-4d59-bdf1-8cd40ac11e37}" symbol="13" label="Rohr.gueltig"/>
        </rule>
        <rule scalemaxdenom="1250" key="{98322a2d-84c0-4a74-bb9b-f4710cfe2f1d}" scalemindenom="750" label="1:1000">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{a578d8f6-54c1-4bb2-82b1-4f3b703662e0}" symbol="14" label="Rohr.gueltig"/>
        </rule>
        <rule scalemaxdenom="3000" key="{f6d5d941-f234-4e54-af4c-c8b4acb8e059}" scalemindenom="1250" label="1:2000">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{abcfd7d1-92d6-4b14-8cc2-1fb52d505d0f}" symbol="15" label="Rohr.gueltig"/>
        </rule>
      </rule>
      <rule filter="punktzeichen_txt = 'Pfahl'" key="{bdf36b74-cca9-4d7e-8c57-85d536d534e7}" label="Pfahl">
        <rule scalemaxdenom="300" key="{b05b8712-fc12-45c2-943e-02b173da2083}" scalemindenom="1" label="1:250">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{74fbeda2-8fe7-4ec0-a6f4-6b52ee62f29a}" symbol="16" label="Pfahl.gueltig"/>
        </rule>
        <rule scalemaxdenom="750" key="{64384600-74ed-48e4-9325-ef8668cee23a}" scalemindenom="300" label="1:500">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{095198b1-3abf-403a-a519-8f3f8407435f}" symbol="17" label="Pfahl.gueltig"/>
        </rule>
        <rule scalemaxdenom="1250" key="{67f32834-e381-499e-9f94-5e2d5822b5dc}" scalemindenom="750" label="1:1000">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{6ed74fab-84a1-4bd6-96fb-7e88795134fa}" symbol="18" label="Pfahl.gueltig"/>
        </rule>
        <rule scalemaxdenom="3000" key="{a3bceef5-7c6c-4e67-8d27-ead91da9d554}" scalemindenom="1250" label="1:2000">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{729353fa-5daa-44db-800c-75ddbcb20d5d}" symbol="19" label="Pfahl.gueltig"/>
        </rule>
      </rule>
      <rule filter="punktzeichen_txt = 'Kreuz'" key="{97c7d47c-ecd6-4d66-be15-7ba09661c447}" label="Kreuz">
        <rule scalemaxdenom="300" key="{b6b03f68-651e-43de-80d3-03b571a20f59}" scalemindenom="1" label="1:250">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{a17e7524-8f2a-463e-a065-a3ff0b64a3c1}" symbol="20" label="Kreuz.gueltig"/>
        </rule>
        <rule scalemaxdenom="750" key="{3b0012ae-62ac-43ec-b542-e3897b9659b8}" scalemindenom="300" label="1:500">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{ae33622e-4748-4105-91e7-55fddcebf4c4}" symbol="21" label="Kreuz.gueltig"/>
        </rule>
        <rule scalemaxdenom="1250" key="{4ba21591-db26-442c-b0da-930e845c8f64}" scalemindenom="750" label="1:1000">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{babe75ee-8f4f-4308-bfd9-b245850a7810}" symbol="22" label="Kreuz.gueltig"/>
        </rule>
        <rule scalemaxdenom="3000" key="{f034c509-6563-49c5-9db8-75cf3e6671fc}" scalemindenom="1250" label="1:2000">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{54d88894-39da-41be-a577-6c58e6475371}" symbol="23" label="Kreuz.gueltig"/>
        </rule>
      </rule>
      <rule filter="punktzeichen_txt = 'unversichert'" key="{45f17e07-4f05-42c0-ab79-0b0e19e94ebf}" label="unversichert">
        <rule scalemaxdenom="300" key="{1d13d54c-e1a7-4dfb-bb10-52577ba64841}" scalemindenom="1" label="1:250">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{1a53512d-641b-4817-9e36-b9ed33aa15a6}" symbol="24" label="unversichert.gueltig"/>
        </rule>
        <rule scalemaxdenom="750" key="{d2d3ac5f-f094-4e31-950e-beb7fe512ec0}" scalemindenom="300" label="1:500">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{78b6b074-7994-4498-afd5-1074601b238e}" symbol="25" label="unversichert.gueltig"/>
        </rule>
        <rule scalemaxdenom="1250" key="{58c9e1d8-40d9-4184-b147-db27fa8a2b9d}" scalemindenom="750" label="1:1000">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{e91dfda3-87d1-4f44-8d1f-1bf9242715b6}" symbol="26" label="unversichert.gueltig"/>
        </rule>
        <rule scalemaxdenom="3000" key="{cedde83c-b479-4f28-ab92-f3c089191d51}" scalemindenom="1250" label="1:2000">
          <rule filter="&quot;gueltigkeit&quot; = 'gueltig'" key="{a75e88ae-7ba1-4791-88b9-621bac2c3c0a}" symbol="27" label="unversichert.gueltig"/>
        </rule>
      </rule>
    </rules>
    <symbols>
