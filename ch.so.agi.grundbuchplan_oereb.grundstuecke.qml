...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="1" maximumScale="25000" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{e653d7a4-8686-4037-a7b7-d4d3111b3e52}">
      <rule filter=" &quot;art_txt&quot;  = 'Liegenschaft'" key="{404cf7ab-1cff-4e60-b3de-415f5afc3917}" label="Liegenschaft">
        <rule scalemaxdenom="300" key="{ee8da832-7c9d-4064-9a4b-14f4053d4c3d}" symbol="0" scalemindenom="1" label="1:250"/>
        <rule scalemaxdenom="750" key="{a1155b4f-0f89-447a-b636-9e7b82fcafad}" symbol="1" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{3c1cd115-2f14-4154-a71d-efcc7aa91a51}" symbol="2" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{342bd10d-3621-42f5-bcaa-1762109fb59e}" symbol="3" scalemindenom="1250" label="1:2000"/>
        <rule scalemaxdenom="25000" key="{b0fad555-7c30-46cd-afe8-1da949a898c3}" symbol="4" scalemindenom="3000" label="1:5000"/>
      </rule>
      <rule filter="&quot;art_txt&quot;  !=   'Liegenschaft' " key="{429089c9-ab10-4702-9451-969beecf0b71}" label="SelbstRecht">
        <rule scalemaxdenom="300" key="{903f6eed-8da9-4395-a980-04fec5138f36}" symbol="5" scalemindenom="1" label="1:250"/>
        <rule scalemaxdenom="750" key="{c84a1fde-acb1-4bba-bdaa-8b18a935cda2}" symbol="6" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{0c2677c5-cb1a-436c-934c-c0c7828e487c}" symbol="7" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{9567fa7a-da8c-4847-b5f1-78f62230a1b6}" symbol="8" scalemindenom="1250" label="1:2000"/>
        <rule scalemaxdenom="25000" key="{95e25bf2-c8e4-4a7c-8582-b16ddaca2561}" symbol="9" scalemindenom="3000" label="1:5000"/>
      </rule>
    </rules>
    <symbols>
