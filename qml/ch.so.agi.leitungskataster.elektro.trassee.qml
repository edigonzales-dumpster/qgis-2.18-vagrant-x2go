...
<qgis version="2.18.15" simplifyAlgorithm="0" minimumScale="0" maximumScale="30000" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="breite">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{402b1917-3b1d-48bf-bdfc-34198ddd66dc}">
      <rule filter="((&quot;art&quot; = 'Kabeltrasse') OR (&quot;art&quot; = 'unbekannt')) AND (&quot;lagebestimmung&quot; = 'genau')" key="{76bc2ae7-b893-421c-80e1-d71d366733f2}" symbol="0" label="Kabeltrasse genau"/>
      <rule filter="((&quot;art&quot; = 'Kabeltrasse') OR (&quot;art&quot; = 'unbekannt')) AND ((&quot;lagebestimmung&quot; = 'unbekannt') OR (&quot;lagebestimmung&quot; = 'ungenau'))" key="{7bd10e06-2a1a-4fb0-a1fc-f4068b6813e4}" symbol="1" label="Kabeltrasse ungenau"/>
      <rule filter="&quot;art&quot; = 'Freileitungsstrasse'" key="{d9407a67-268e-4e9e-b822-209d1fa580a1}" symbol="2" label="Freileitungstrasse"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="0;7;1.5;1.5"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="breite" expression=""/>
