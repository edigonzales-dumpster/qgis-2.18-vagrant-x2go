...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="bezirksname">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="bezirksnummer">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <aliases>
    ...
    <alias field="bezirksname" index="2" name=""/>
    <alias field="bezirksnummer" index="3" name=""/>
    <alias field="kantonsname" index="4" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="bezirksname"/>
      <column width="-1" hidden="0" type="field" name="bezirksnummer"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="bezirksname" expression=""/>
    <default field="bezirksnummer" expression=""/>
