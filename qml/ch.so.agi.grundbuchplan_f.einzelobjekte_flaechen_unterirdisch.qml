...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="1" maximumScale="5000" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{05bb6c66-f3ac-4e3b-9490-e7b252451b3b}">
      <rule filter=" &quot;art_txt&quot;  =  'unterirdisches_Gebaeude'  OR  &quot;art_txt&quot;  =  'Reservoir' " key="{eccb1f14-0ede-4624-8446-c36aa1bb5407}">
        <rule scalemaxdenom="300" key="{b5ebd4bd-2ca9-4f73-85d8-82da3ad03c7f}" symbol="0" label="1:250"/>
        <rule scalemaxdenom="750" key="{4265fcfc-d421-4bcd-9918-c0d82986334e}" symbol="1" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{934d07c1-1061-452c-b018-fc3ef2be22ae}" symbol="2" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{c6e7264a-b516-4e52-8c24-3aff21ad77a7}" symbol="3" scalemindenom="1250" label="1:2000"/>
        <rule scalemaxdenom="6000" key="{da00d444-90f2-480e-9298-1dcc4638afd2}" symbol="4" scalemindenom="3000" label="1:5000"/>
      </rule>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="PointPatternFill" locked="0">
          <prop k="displacement_x" v="1.05"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="4">
        <layer pass="0" class="PointPatternFill" locked="0">
          <prop k="displacement_x" v="0.35"/>
          <prop k="displacement_x_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="displacement_x_unit" v="MM"/>
          <prop k="displacement_y" v="0"/>
          <prop k="displacement_y_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="displacement_y_unit" v="MM"/>
          <prop k="distance_x" v="0.7"/>
          <prop k="distance_x_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="distance_x_unit" v="MM"/>
          <prop k="distance_y" v="0.7"/>
          <prop k="distance_y_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="distance_y_unit" v="MM"/>
          <prop k="outline_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="outline_width_unit" v="MM"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;art_txt&quot;" sortOrder="0">
    <columns>
