...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="1" maximumScale="5000" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="numpos">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{e653d7a4-8686-4037-a7b7-d4d3111b3e52}">
      <rule filter=" &quot;mutation&quot;  =  'f' " key="{2d386b59-dc25-4ff2-b26c-76e900feb035}">
        <rule scalemaxdenom="300" key="{0ef7cb13-ea5c-4a93-a9b6-67a7be411d2d}" symbol="0" scalemindenom="1" label="1:250"/>
        <rule scalemaxdenom="750" key="{1e160bf8-e7d8-4f7f-9794-92e358f542b4}" symbol="1" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{9d44f725-b665-4d1a-801e-74c6c8c0b3bc}" symbol="2" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{11f50c79-8784-4fa0-9b64-d78862ca60dd}" symbol="3" scalemindenom="1250" label="1:2000"/>
        <rule scalemaxdenom="6000" key="{46d76ee4-f6f9-48dc-8243-e009ea6d12af}" symbol="4" scalemindenom="3000" label="1:5000"/>
      </rule>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="liegenschaft_von" index="2" name=""/>
    ...
    <alias field="numpos" index="8" name=""/>
    <alias field="nummer" index="9" name=""/>
    <alias field="mutation" index="10" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="numpos"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="liegenschaft_von" expression=""/>
    ...
    <default field="numpos" expression=""/>
