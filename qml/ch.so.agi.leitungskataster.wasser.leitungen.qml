...
<qgis version="2.18.15" simplifyAlgorithm="0" minimumScale="0" maximumScale="30000" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="nennweite">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="druckzone">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{ab2788c1-6ff7-4c3c-b43b-a845e1b18742}">
      <rule filter="&quot;lagebestimmung&quot; = 'genau' AND (&quot;funktion&quot; != 'Anschlussleitung.normal' AND &quot;funktion&quot; != 'Anschlussleitung.gemeinsam')" key="{b1a69418-8c91-4691-aed9-f6fa1b17cfd7}" symbol="0" label="Hauptleitungen genau"/>
      <rule filter="&quot;lagebestimmung&quot; != 'genau' AND (&quot;funktion&quot; != 'Anschlussleitung.normal' AND &quot;funktion&quot; != 'Anschlussleitung.gemeinsam')" key="{32d51389-2a32-444a-94f2-d8c80ebc3181}" symbol="1" label="Hauptleitungen ungenau"/>
      <rule filter="&quot;lagebestimmung&quot; = 'genau' AND (&quot;funktion&quot; = 'Anschlussleitung.normal' OR &quot;funktion&quot; = 'Anschlussleitung.gemeinsam')" key="{2c59064e-080a-4a5e-bee8-66badd2896e5}" symbol="2" label="Anschlussleitungen genau"/>
      <rule filter="&quot;lagebestimmung&quot; != 'genau' AND (&quot;funktion&quot; = 'Anschlussleitung.normal' OR &quot;funktion&quot; = 'Anschlussleitung.gemeinsam')" key="{824b0aa0-f1ab-4adc-b0ed-aa708b00a037}" symbol="3" label="Anschlussleitungen ungenau"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="0,109,255,255"/>
  ...
  <aliases>
    ...
    <alias field="baujahr" index="2" name="Baujahr"/>
    <alias field="funktion" index="3" name="Funktion"/>
    <alias field="material" index="4" name="Material"/>
    <alias field="material_kurz" index="5" name=""/>
    <alias field="durchmesser" index="6" name="Durchmesser"/>
    <alias field="nennweite" index="7" name="Nennweite"/>
    <alias field="lagebestimmung" index="8" name="Lagebestimmung"/>
    <alias field="status" index="9" name="Status"/>
    <alias field="druckzone" index="10" name="Druckzone"/>
    <alias field="eigentuemer" index="11" name="Eigentümer"/>
    <alias field="fontcolor" index="12" name=""/>
  </aliases>
  <excludeAttributesWMS>
    <attribute>material_kurz</attribute>
