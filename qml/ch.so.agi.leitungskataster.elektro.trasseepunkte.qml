<qgis hasScaleBasedVisibilityFlag="1" maxLabelScale="1e+08" maximumScale="1000" minLabelScale="1" minimumScale="0" readOnly="0" scaleBasedLabelVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.18.15">
  ...
  <renderer-v2 attr="art" enableorderby="0" forceraster="0" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category label="Lampenstelle" render="true" symbol="0" value="Lampenstelle" />
      <category label="Maststation" render="true" symbol="1" value="Maststation" />
      <category label="Schacht" render="true" symbol="2" value="Schacht" />
      <category label="Verteilkabine" render="true" symbol="3" value="Verteilkabine" />
    </categories>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" name="0" type="marker">
        <layer class="SvgMarker" locked="0" pass="0">
          ...
          <prop k="name" v="symbols/4d18475d49c76b62298b92fe759499c2.svg" />
          <prop k="offset" v="0,0" />
      ...
      <symbol alpha="1" clip_to_extent="1" name="1" type="marker">
        <layer class="SvgMarker" locked="0" pass="0">
          ...
          <prop k="color" v="0,0,0,255" />
          <prop k="horizontal_anchor_point" v="1" />
          <prop k="name" v="symbols/b323213e1a1b255f880184005f9cece4.svg" />
          <prop k="offset" v="0,0" />
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0" />
          <prop k="offset_unit" v="MM" />
          <prop k="outline_color" v="0,0,0,255" />
      ...
      <symbol alpha="1" clip_to_extent="1" name="3" type="marker">
        <layer class="SvgMarker" locked="0" pass="0">
          ...
          <prop k="color" v="0,0,0,255" />
          <prop k="horizontal_anchor_point" v="1" />
          <prop k="name" v="symbols/60bbe3aa26628159f36f74109433833f.svg" />
          <prop k="offset" v="0,0" />
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0" />
          <prop k="offset_unit" v="MM" />
          <prop k="outline_color" v="0,0,0,255" />
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="name_nummer" />
  ...
  <annotationform>/sogis_nas/daten_tools/projekte/sogis/gemeindegis/BU_Zuchwil</annotationform>
  <aliases>
    <alias field="t_id" index="0" name="" />
    <alias field="tid" index="1" name="" />
    <alias field="id" index="2" name="" />
    <alias field="name_nummer" index="3" name="Name/Nummer" />
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="tid" type="field" width="-1" />
  ...
  <editform>/sogis_nas/daten_tools/projekte/sogis/gemeindegis/Zuchwil</editform>
  <editforminit />
