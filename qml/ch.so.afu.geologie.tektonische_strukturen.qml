...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{1738194e-68ef-48a6-a882-413e159a9350}">
      <rule filter="symbol = 101" key="{c9e6efc2-f4f3-462e-a169-951a745f2f6c}" symbol="0" label="AE-Spur Antiklinale"/>
      <rule filter="symbol = 102" key="{bed82d03-4b96-4283-a0b4-5867c0ccb5fe}" symbol="1" label="AE-Spur Synklinale"/>
      <rule filter="symbol = 105" key="{7c72fe5a-fb15-4b54-a2d8-32ccd5155d19}" symbol="2" label="Überschiebung"/>
      <rule filter="symbol = 106" key="{4342a2ca-2e58-482c-9d3e-b61be7a56ba8}" symbol="3" label="Überschiebung, vermutet"/>
      <rule filter="symbol = 107 OR symbol = 109" key="{732ad18e-46ae-4e84-ba35-a5123b347256}" symbol="4" label="Bruch"/>
      <rule filter="symbol = 108 OR symbol = 110" key="{ac27b743-59f0-48ab-bb76-7744defa9364}" symbol="5" label="Bruch, vermutet"/>
    </rules>
    <symbols>
