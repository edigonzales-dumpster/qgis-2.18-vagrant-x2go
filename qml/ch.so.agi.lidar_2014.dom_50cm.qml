...
<qgis version="2.18.15" minimumScale="1" maximumScale="20000" hasScaleBasedVisibilityFlag="1">
  <pipe>
    <rasterrenderer opacity="1" alphaBand="0" classificationMax="1200" classificationMinMaxOrigin="User" band="1" classificationMin="300" type="singlebandpseudocolor">
      <rasterTransparency>
      ...
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" clip="0">
          <item alpha="255" value="300" label="300m bis 400m" color="#f0f2dd"/>
