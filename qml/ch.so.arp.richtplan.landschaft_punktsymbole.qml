<qgis hasScaleBasedVisibilityFlag="1" maxLabelScale="1e+08" maximumScale="100000" minLabelScale="0" minimumScale="17000" readOnly="0" scaleBasedLabelVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.18.17">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{72ee6a56-3c0c-41e7-89c5-56f42a8e47ea}">
      <rule filter="&quot;objekttyp&quot; = 'Freizeit_Sport_Anlage' and  &quot;status&quot;  =   'bestehend' " key="{8ebe25bb-3a15-412a-8ca9-7642fc23a2ef}" label="Anlage für Freizeit und Sport von nationaler/regionaler Bedeutung bestehend" scalemaxdenom="100000" scalemindenom="17000" symbol="0" />
      <rule filter="&quot;objekttyp&quot; = 'Freizeit_Sport_Anlage'and &quot;status&quot;  =   'neu' " key="{cb22502c-6811-49ee-9731-c4ef5002d829}" label="Anlage für Freizeit und Sport von nationaler/regionaler Bedeutung Erweiterung" scalemaxdenom="100000" scalemindenom="17000" symbol="1" />
      <rule filter="&quot;objekttyp&quot; = 'Gueterregulierung'" key="{9c5dddf7-158e-4428-93a3-d08f5302483b}" label="Güterregulierung" scalemaxdenom="100000" scalemindenom="17000" symbol="2" />
    </rules>
    <symbols>
