...
<qgis version="2.18.17" simplifyAlgorithm="0" minimumScale="1" maximumScale="3000" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <labeling type="rule-based">
    <rules key="{591ec233-cd53-4f28-8ed7-7690bb7444c7}">
      <rule scalemaxdenom="750" filter=" &quot;mutation&quot;  =  'f' " key="{f90cd997-62b1-41d2-b8ce-780a24ae7b16}" scalemindenom="1">
        <settings>
      ...
      <rule scalemaxdenom="1250" filter=" &quot;mutation&quot;  =  'f' " key="{c4d95e0b-59a3-44ce-b6bd-c9db50be99fd}" scalemindenom="750">
        <settings>
      ...
      <rule scalemaxdenom="3000" filter=" &quot;mutation&quot;  =  'f' " key="{0678b95a-d282-433c-a23c-79e60e4ab593}" scalemindenom="1250">
        <settings>
      ...
      <rule scalemaxdenom="6000" filter=" &quot;mutation&quot;  =  'f' " key="{f8a2c9ae-8a0c-43f1-aad2-068cccb44e85}" scalemindenom="3000">
        <settings>
