<qgis hasScaleBasedVisibilityFlag="1" maxLabelScale="1e+08" maximumScale="100000" minLabelScale="0" minimumScale="17000" readOnly="0" scaleBasedLabelVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.18.17">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{72ee6a56-3c0c-41e7-89c5-56f42a8e47ea}">
      <rule filter=" &quot;objekttyp&quot; in ( 'Autobahnanschluss.Halbanschluss' , 'Autobahnanschluss.Vollanschluss' ) and &quot;status&quot;  =  'bestehend' " key="{17919ea1-5f15-4aa9-9b71-a5f50140a8e7}" label="Autobahnanschluss" symbol="0" />
      <rule filter=" &quot;objekttyp&quot; in ( 'Autobahnanschluss.Halbanschluss',  'Autobahnanschluss.Vollanschluss' ) and  &quot;status&quot;  =  'Erweiterung'" key="{17fa1ac1-00be-4275-ab4a-aded00a5f027}" label="Autobahnanschluss Erweiterung" symbol="1" />
      <rule filter="&quot;objekttyp&quot; = 'Bahn_Bus_Haltestelle'" key="{216d256a-2665-4510-9c7f-927e79cea62b}" label="Bahnhaltestelle/Busbahnhof" symbol="2" />
      <rule filter="&quot;objekttyp&quot; = 'Flugplatz'" key="{ea3b54bf-51d4-456f-8502-e26b08361160}" label="Flugplatz/Flugfeld" symbol="3" />
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" name="1" type="marker">
        <layer class="SvgMarker" locked="0" pass="0">
          ...
          <prop k="horizontal_anchor_point" v="1" />
          <prop k="name" v="symbols/94f042bf76af29eadeb71d67a53d77f3.svg" />
          <prop k="offset" v="0,0" />
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0" />
          <prop k="offset_unit" v="MM" />
          <prop k="outline_color" v="0,0,0,255" />
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;objekttyp&quot;" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="status" type="field" width="158" />
