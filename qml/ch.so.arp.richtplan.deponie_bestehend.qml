<qgis hasScaleBasedVisibilityFlag="0" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="0" minimumScale="17000" readOnly="0" scaleBasedLabelVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.18.17">
  <edittypes>
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{42194538-88de-4b4e-859f-69cee08dd827}">
      <rule filter="&quot;objekttyp&quot;  =  'Deponie' and &quot;status&quot;  =  'bestehend' " key="{54cef7f8-c3b5-4bf8-9ef8-1f3b2670f107}" label="Deponiestandort bestehend" symbol="0" />
    </rules>
    <symbols>
        ...
        <layer class="CentroidFill" locked="0" pass="0">
          ...
          <symbol alpha="1" clip_to_extent="1" name="@0@0" type="marker">
            <layer class="SvgMarker" locked="0" pass="0">
              ...
              <prop k="name" v="symbols/59716002e28737e17eb0f854c7309066.svg" />
              <prop k="offset" v="0,0" />
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;objekttyp&quot;" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="objektnummer" type="field" width="304" />
      <column hidden="0" name="objekttyp" type="field" width="415" />
