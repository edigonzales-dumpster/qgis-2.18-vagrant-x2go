...
<qgis version="2.18.15" simplifyAlgorithm="0" minimumScale="0" maximumScale="1000" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          ...
          <prop k="outline_color" v="0,110,255,255"/>
  ...
  <annotationform>/home_nas/sogis/barpareb/agi_gemeindegis/qgis</annotationform>
  <aliases>
    <alias field="t_id" index="0" name=""/>
    <alias field="id" index="1" name=""/>
    <alias field="name_nummer" index="2" name="Name/Nummer"/>
    <alias field="art" index="3" name=""/>
    <alias field="art_txt" index="4" name="Art"/>
  </aliases>
  ...
  <editform>/home_nas/sogis/barpareb/agi_gemeindegis/qgis</editform>
  <editforminit/>
