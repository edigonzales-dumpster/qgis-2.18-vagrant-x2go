...
<qgis version="2.18.17" simplifyAlgorithm="0" minimumScale="17000" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{b334c362-a645-4d52-9b44-d9c3aebc1b7d}">
      <rule checkstate="0" filter="&quot;objekttyp&quot; = 'Bahnlinie.Schiene'" key="{1715b73c-7a44-4da2-824f-66ad38dd3e7a}" symbol="0" label="Bahnlinie"/>
      <rule filter="&quot;objekttyp&quot; = 'Kantonsstrasse' and  &quot;status&quot;  =   'bestehend' " key="{6ce369bd-08e6-4ffc-a3f3-cf51cfde377c}" symbol="1" label="Kantonsstrasse"/>
      <rule filter="&quot;objekttyp&quot; = 'Kantonsstrasse' and  &quot;status&quot;  =  'neu' " key="{a558edd2-f498-4344-a191-6029579973ba}" symbol="2" label="Kantonsstrasse Vorhaben"/>
      <rule filter="&quot;objekttyp&quot; = 'Nationalstrasse.Strasse' and  &quot;status&quot;  =  'neu' " key="{9b606429-dc56-4962-8acb-23b270f66acb}" symbol="3" label="Nationalstrasse Vorhaben"/>
      <rule filter="(&quot;objekttyp&quot; = 'Nationalstrasse.Strasse' or &quot;objekttyp&quot; = 'Nationalstrasse.Tunnel')" key="{30fb9e72-67cf-44b4-be70-6f3c381f5762}" symbol="4" label="Nationalstrasse"/>
      <rule checkstate="0" filter="&quot;objekttyp&quot; = 'Nationalstrasse.Tunnel'" key="{8b9da503-152a-498e-ae85-05946115321c}" symbol="5" label="Nationalstrassentunnel"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="objektname" index="4" name=""/>
    <alias field="abstimmungskategorie" index="5" name=""/>
    <alias field="bedeutung" index="6" name=""/>
    <alias field="planungsstand" index="7" name=""/>
    <alias field="dokumente" index="8" name=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;objekttyp&quot;" sortOrder="0">
    <columns>
      ...
      <column width="405" hidden="0" type="field" name="objekttyp"/>
