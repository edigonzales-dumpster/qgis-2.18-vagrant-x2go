<qgis hasScaleBasedVisibilityFlag="1" maxLabelScale="1e+08" maximumScale="1e+08" minLabelScale="1" minimumScale="17000" readOnly="0" scaleBasedLabelVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.18.17">
  <edittypes>
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{c0f0be50-a4c0-45e6-a5b0-95e7cb9a20ca}">
      <rule filter=" &quot;o_art&quot; = 'E12'" key="{b4ef19ef-74f8-4214-9112-420fd8696f2f}" label="Abbaustelle Vorhaben" symbol="0" />
      <rule filter=" &quot;o_art&quot; = 'E11'" key="{882d1a71-67dc-4100-a14f-d03d381a9d11}" label="Abbaugebiet Erweiterung" symbol="1" />
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" name="0" type="marker">
        <layer class="SvgMarker" locked="0" pass="0">
          <prop k="angle" v="0" />
          <prop k="color" v="165,237,145,255" />
          <prop k="horizontal_anchor_point" v="1" />
          <prop k="name" v="symbols/c1d2f14a2c0d672eaf4e65cdb6683899.svg" />
          <prop k="offset" v="0,0" />
      ...
      <symbol alpha="1" clip_to_extent="1" name="1" type="marker">
        <layer class="SvgMarker" locked="0" pass="0">
          ...
          <prop k="horizontal_anchor_point" v="1" />
          <prop k="name" v="symbols/6beb5d4e1ab5cf3bf8672580437e7cc1.svg" />
          <prop k="offset" v="0,0" />
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0" />
          <prop k="offset_unit" v="MM" />
          <prop k="outline_color" v="0,0,0,255" />
