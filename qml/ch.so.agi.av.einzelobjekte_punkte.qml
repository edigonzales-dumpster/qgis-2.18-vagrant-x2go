<qgis hasScaleBasedVisibilityFlag="1" maxLabelScale="1e+08" maximumScale="6000" minLabelScale="1" minimumScale="0" readOnly="0" scaleBasedLabelVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.18.15">
  <edittypes>
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{ec9e9f65-0902-4a37-97fc-23c3108dc4ad}">
      ...
      <rule filter="&quot;art_txt&quot; = 'Bezugspunkt'" key="{241ae3cb-8bed-4b2a-a30d-f5049c9bd6fd}" label="Bezugspunkte" symbol="35" />
      <rule filter="&quot;art_txt&quot; = 'uebriger_Gebaeudeteil'" key="{6cfba596-eece-46eb-b88b-1f253577485f}" label="gebteil" symbol="36" />
    </rules>
    <symbols>
