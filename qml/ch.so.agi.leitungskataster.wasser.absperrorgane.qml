<qgis hasScaleBasedVisibilityFlag="1" maxLabelScale="1e+08" maximumScale="1000" minLabelScale="1" minimumScale="0" readOnly="0" scaleBasedLabelVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.18.15">
  <edittypes>
    ...
    <edittype name="id" widgetv2type="Hidden">
      <widgetv2config constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="name_nummer" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="art" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="druckzone" widgetv2type="TextEdit">
      <widgetv2config IsMultiline="0" UseHtml="0" constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
    <edittype name="symbolori" widgetv2type="Hidden">
      <widgetv2config constraint="" constraintDescription="" fieldEditable="1" labelOnTop="0" notNull="0" />
    </edittype>
  </edittypes>
  <renderer-v2 attr="art" enableorderby="0" forceraster="0" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category label="Schieber (Anbohrschieber)" render="true" symbol="0" value="Schieber.Anbohrschieber" />
      <category label="Schieber (Anschlussschieber)" render="true" symbol="1" value="Schieber.Anschlussschieber" />
      <category label="Schieber (Streckenschieber)" render="true" symbol="2" value="Schieber.Streckenschieber" />
      <category label="Schieber (Typ unbekannt)" render="true" symbol="3" value="Schieber.unbekannt" />
      <category label="Klappe (Normalklappe)" render="true" symbol="4" value="Klappe.Normalklappe" />
      <category label="Klappe (Streckenklappe)" render="true" symbol="5" value="Klappe.Streckenklappe" />
      <category label="Klappe (Typ unbekannt)" render="true" symbol="6" value="Klappe.unbekannt" />
      <category label="Klappe (Zonenklappe)" render="true" symbol="7" value="Klappe.Zonenklappe" />
    </categories>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" name="0" type="marker">
        <layer class="SvgMarker" locked="0" pass="0">
          ...
          <prop k="angle_dd_field" v="symbolori" />
          <prop k="angle_dd_useexpr" v="0" />
          <prop k="color" v="0,0,0,255" />
          <prop k="horizontal_anchor_point" v="1" />
          <prop k="name" v="symbols/4862f8e7fb267b8e36252bc54c885eeb.svg" />
          <prop k="offset" v="0,0" />
      ...
      <symbol alpha="1" clip_to_extent="1" name="4" type="marker">
        <layer class="SvgMarker" locked="0" pass="0">
          ...
          <prop k="color" v="0,0,0,255" />
          <prop k="horizontal_anchor_point" v="1" />
          <prop k="name" v="symbols/09ee809bf96c3203710397215f6a2232.svg" />
          <prop k="offset" v="0,0" />
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0" />
          <prop k="offset_unit" v="MM" />
          <prop k="outline_color" v="0,0,0,255" />
  ...
  <aliases>
    ...
    <alias field="name_nummer" index="2" name="Name/Nummer" />
    <alias field="art" index="3" name="Art" />
    <alias field="druckzone" index="4" name="Druckzone" />
    <alias field="symbolori" index="5" name="" />
  </aliases>
  <excludeAttributesWMS>
    <attribute>symbolori</attribute>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="name_nummer" type="field" width="-1" />
      <column hidden="0" name="art" type="field" width="-1" />
      <column hidden="0" name="druckzone" type="field" width="-1" />
      <column hidden="0" name="symbolori" type="field" width="-1" />
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default expression="" field="name_nummer" />
    <default expression="" field="art" />
    <default expression="" field="druckzone" />
    <default expression="" field="symbolori" />
  </defaults>
  <previewExpression />
