  ...
  <labeling type="rule-based">
    <rules key="{db72b1bf-c274-41a4-baab-bb6be7e13471}">
      <rule scalemaxdenom="750" key="{366d3dfe-a147-4a49-a58d-b05f3495f6df}" scalemindenom="1">
        <settings>
          <text-style fontItalic="0" fontFamily="Frutiger LT Com 55 Roman" fontLetterSpacing="0" fontUnderline="0" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="0,0,0,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="22.4" fieldName="ortsname" namedStyle="75 Black" fontWordSpacing="0" useSubstitutions="0">
            <substitutions/>
          </text-style>
