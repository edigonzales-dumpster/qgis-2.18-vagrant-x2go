...
<qgis version="2.18.15" simplifyAlgorithm="0" minimumScale="0" maximumScale="1000" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="172,58,48,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/Color" value="1~~0~~~~fontcolor"/>
    ...
    <property key="labeling/fieldName" value="CASE WHEN &quot;material_kurz&quot; IS NULL THEN '' ELSE &quot;material_kurz&quot; END  || ' '  ||   &quot;nennweite&quot; ||&#xa;CASE WHEN &quot;baujahr&quot; IS NULL THEN&#xa;'' ELSE &#xa;'/' || &quot;baujahr&quot;&#xa;END"/>
