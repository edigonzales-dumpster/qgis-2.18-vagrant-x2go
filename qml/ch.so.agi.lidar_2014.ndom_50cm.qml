...
<qgis version="2.18.15" minimumScale="1" maximumScale="20000" hasScaleBasedVisibilityFlag="1">
  <pipe>
    <rasterrenderer opacity="1" alphaBand="-1" classificationMax="27.0716" classificationMinMaxOrigin="CumulativeCutFullExtentEstimated" band="1" classificationMin="0.0135713" type="singlebandpseudocolor">
      <rasterTransparency>
      ...
      <rastershader>
        <colorrampshader colorRampType="DISCRETE" clip="1">
          <item alpha="255" value="1" label="&lt;1m" color="#ffffff"/>
