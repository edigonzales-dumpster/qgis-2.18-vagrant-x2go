...
<qgis version="2.18.15" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="ada_nr">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  ...
  <aliases>
    ...
    <alias field="gmde_name" index="4" name=""/>
    <alias field="gmde_nr" index="5" name=""/>
    <alias field="bzrk_nr" index="6" name=""/>
    <alias field="eg_nr" index="7" name=""/>
    <alias field="plz" index="8" name=""/>
    <alias field="ktn_nr" index="9" name=""/>
    <alias field="ada_nr" index="10" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="gmde_nr"/>
      <column width="-1" hidden="0" type="field" name="bzrk_nr"/>
      <column width="-1" hidden="0" type="field" name="eg_nr"/>
      <column width="-1" hidden="0" type="field" name="plz"/>
      <column width="-1" hidden="0" type="field" name="ktn_nr"/>
      <column width="-1" hidden="0" type="field" name="ada_nr"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="gmde_nr" expression=""/>
    <default field="bzrk_nr" expression=""/>
    <default field="eg_nr" expression=""/>
    <default field="plz" expression=""/>
    <default field="ktn_nr" expression=""/>
    <default field="ada_nr" expression=""/>
  </defaults>
