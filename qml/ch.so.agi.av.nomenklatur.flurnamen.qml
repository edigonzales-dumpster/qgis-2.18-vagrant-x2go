...
<qgis version="2.18.17" simplifyAlgorithm="0" minimumScale="0" maximumScale="15000" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/Family" value="1~~1~~&quot;Cadastra&quot;~~"/>
    <property key="labeling/dataDefined/Hali" value="1~~0~~~~hali"/>
    <property key="labeling/dataDefined/PositionX" value="1~~1~~x(geom_from_wkt(substr(pos,11,40)))~~"/>
    <property key="labeling/dataDefined/PositionY" value="1~~1~~y(geom_from_wkt(substr(pos,11,40)))~~"/>
    <property key="labeling/dataDefined/Rotation" value="1~~0~~~~orientierung"/>
  ...
  <annotationform>/var/www/maps/qgis-server-projekte/nomenklatur</annotationform>
  <aliases>
  ...
  <editform>/var/www/maps/qgis-server-projekte/nomenklatur</editform>
  <editforminit/>
