...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="0" maximumScale="100000" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{c9c3fcce-7a68-4b93-99eb-6884582b421b}">
      <rule scalemaxdenom="60000" filter=" &quot;schoener_stein&quot;  =  't' " key="{a0b8af06-df02-4641-8d11-ef49d50cefa0}" symbol="0" scalemindenom="1" label="schöner Stein"/>
      <rule scalemaxdenom="3000" key="{11869d77-14fb-4616-9724-979d066d2284}" symbol="1" scalemindenom="1" label="Hoheitsgrenzpunkt"/>
      <rule scalemaxdenom="60000" key="{faf30629-96fa-49c4-800c-0c39d3964a49}" symbol="2" scalemindenom="3000" label="Hoheitsgrenzpunkt"/>
    </rules>
    <symbols>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="236" hidden="0" type="field" name="schoener_stein"/>
