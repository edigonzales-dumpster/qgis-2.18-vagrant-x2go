...
<qgis version="2.18.15" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="erdabp_">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="erdabp_id">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{37e95e5a-1dbd-47cd-98b4-6d475e4c6a5f}">
      <rule key="{2c9e031e-61df-4b34-b00d-90c249ad6516}" symbol="0" label="Private Quellen abklären"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="LinePatternFill" locked="0">
          <prop k="angle" v="45"/>
          <prop k="color" v="9,156,97,255"/>
          <prop k="distance" v="2.8"/>
  ...
  <aliases>
    ...
    <alias field="erdabp_" index="3" name=""/>
    <alias field="erdabp_id" index="4" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="-124409928">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="erdabp_"/>
      <column width="-1" hidden="0" type="field" name="erdabp_id"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="erdabp_" expression=""/>
    <default field="erdabp_id" expression=""/>
  </defaults>
