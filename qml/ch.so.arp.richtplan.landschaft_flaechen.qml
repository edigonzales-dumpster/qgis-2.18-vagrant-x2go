...
<qgis version="2.18.17" simplifyAlgorithm="0" minimumScale="17000" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="objekttyp">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="weitere_informationen">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="abstimmungskategorie">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="bedeutung">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="planungsstand">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{5a7a0579-6af2-4c47-b868-eb6536038399}">
      <rule filter=" &quot;objekttyp&quot;  = 'Fruchtfolgeflaeche'" key="{aa84c687-c5d5-4b82-88a9-eb4aab64cabc}" symbol="0" label="Fruchtfolgefläche"/>
      <rule filter="&quot;objekttyp&quot; = 'Juraschutzzone'" key="{2a085795-3fb8-4276-9d57-12ac21a5e80f}" symbol="1" label="Juraschutzzone"/>
      <rule filter="&quot;objekttyp&quot; = 'kantonale_Uferschutzzone'" key="{13d9c710-0cfc-424c-9fe5-c65af96f4618}" symbol="2" label="Kantonale Uferschutzzone"/>
      <rule filter=" &quot;objekttyp&quot; =  'kantonales_Naturreservat' " key="{6680eeb1-d279-4de0-b5a8-b82b5d48245b}" symbol="3" label="Naturreservat"/>
      <rule filter="&quot;objekttyp&quot; = 'BLN_Gebiet'" key="{fffe3779-71db-49c6-adcf-c4e43c77f146}" symbol="4" label="BLN_Gebiet"/>
      <rule filter="&quot;objekttyp&quot; = 'kantonales_Vorranggebiet'" key="{8520d7b6-a375-4e94-a869-302b8671593d}" symbol="5" label="Kantonales Vorranggebiet"/>
      <rule filter="&quot;objekttyp&quot; = 'Naturpark'" key="{83d495f1-041c-44b3-a46b-8568e921210c}" symbol="6" label="Naturpark"/>
      <rule filter="&quot;objekttyp&quot; = 'Witischutzzone'" key="{e12bd8b7-8756-418d-b260-758222d5a91e}" symbol="7" label="Witischutzzone"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="255,255,51,77"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="3">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="0,122,0,51"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="1.85"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0.37"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="4">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="miter"/>
          <prop k="line_color" v="204,153,51,88"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="1.85"/>
          <prop k="line_width_unit" v="MM"/>
        ...
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="miter"/>
          <prop k="line_color" v="204,102,0,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.35"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="5">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="miter"/>
          <prop k="line_color" v="0,122,0,89"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="1.85"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0.75"/>
        ...
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="miter"/>
          <prop k="line_color" v="0,122,0,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.35"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="6">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="miter"/>
          <prop k="line_color" v="255,204,102,89"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="1.85"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0.75"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="7">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="miter"/>
          <prop k="line_color" v="153,255,102,140"/>
          <prop k="line_style" v="solid"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;status&quot;" sortOrder="0">
    <columns>
      ...
      <column width="447" hidden="0" type="field" name="objekttyp"/>
      <column width="-1" hidden="0" type="field" name="weitere_informationen"/>
      <column width="344" hidden="0" type="field" name="objektname"/>
      <column width="-1" hidden="0" type="field" name="abstimmungskategorie"/>
      <column width="-1" hidden="0" type="field" name="bedeutung"/>
      <column width="-1" hidden="0" type="field" name="planungsstand"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="objekttyp" expression=""/>
    <default field="weitere_informationen" expression=""/>
    <default field="gemeindenamen" expression=""/>
    <default field="objektname" expression=""/>
    <default field="abstimmungskategorie" expression=""/>
    <default field="bedeutung" expression=""/>
    <default field="planungsstand" expression=""/>
