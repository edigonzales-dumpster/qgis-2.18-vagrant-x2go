...
<qgis version="2.18.15" simplifyAlgorithm="0" minimumScale="0" maximumScale="30000" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="zugaenglichkeit">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="rueckstaukote">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="sohlenkote">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="funktion">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="hochwasserkote">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="sbw_funktion">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  ...
  <aliases>
    ...
    <alias field="id" index="2" name="ID"/>
    ...
    <alias field="zugaenglichkeit" index="8" name="Zugang"/>
    <alias field="rueckstaukote" index="9" name="Rückstaukote"/>
    <alias field="sohlenkote" index="10" name="Sohlenkote"/>
    <alias field="funktion" index="11" name="Funktion"/>
    <alias field="hochwasserkote" index="12" name="Hochwasserkote"/>
    <alias field="sbw_funktion" index="13" name="SBW Funktion"/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="rueckstaukote"/>
      <column width="-1" hidden="0" type="field" name="sohlenkote"/>
      <column width="-1" hidden="0" type="field" name="funktion"/>
      <column width="-1" hidden="0" type="field" name="hochwasserkote"/>
      <column width="-1" hidden="0" type="field" name="sbw_funktion"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="rueckstaukote" expression=""/>
    <default field="sohlenkote" expression=""/>
    <default field="funktion" expression=""/>
    <default field="hochwasserkote" expression=""/>
    <default field="sbw_funktion" expression=""/>
  </defaults>
