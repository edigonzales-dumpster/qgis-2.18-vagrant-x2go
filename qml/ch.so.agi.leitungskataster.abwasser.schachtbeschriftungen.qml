...
<qgis version="2.18.15" simplifyAlgorithm="0" minimumScale="0" maximumScale="500" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="bauwerktext">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="bauwerktext"/>
  ...
  <aliases>
    ...
    <alias field="bauwerktext" index="2" name="Bauwerkstext"/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="bauwerktext"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="bauwerktext" expression=""/>
  </defaults>
