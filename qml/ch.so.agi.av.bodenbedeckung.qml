<qgis hasScaleBasedVisibilityFlag="1" maxLabelScale="1e+08" maximumScale="20000" minLabelScale="1" minimumScale="0" readOnly="0" scaleBasedLabelVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="2.18.28">
  <edittypes>
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{49652c06-68b8-40ef-bd97-2b81be29a1aa}">
      <rule filter="&quot;art_txt&quot; IN ('Steinbruch','Kiesgrube', 'Deponie','uebriger_Abbau', 'Acker_Wiese','Weide', 'Bahn', 'Fels', 'Gartenanlage','Parkanlage_humusiert','Sportanlage_humusiert','Friedhof', 'Geroell_Sand', 'geschlossener_Wald', 'Gletscher_Firn', 'Hoch_Flachmoor', 'Reben', 'Schilfguertel', 'uebrige_befestigte', 'Sportanlage_befestigt', 'Lagerplatz', 'Boeschungsbauwerk', 'Gebaeudeerschliessung', 'Parkplatz', 'uebrige_bestockte','Parkanlage_bestockt', 'Hecke', 'uebrige_Intensivkultur','Obstkultur', 'uebrige_vegetationslose', 'Wytweide_dicht', 'Wytweide_offen')" key="{c938e51a-1c68-4261-a1b2-416068f9a913}" label="gestrichelt">
        <rule key="{4f62fe06-57d0-4bd8-80cc-5ea3dde6bd8f}" label="1:250" scalemaxdenom="300" scalemindenom="1" symbol="0" />
        <rule key="{25788c21-88d6-4cb4-bc59-2f221279f5d3}" label="1:500" scalemaxdenom="750" scalemindenom="300" symbol="1" />
        <rule key="{7266d8c0-dc31-4089-b73b-c188fe1cd026}" label="1:1000" scalemaxdenom="1250" scalemindenom="750" symbol="2" />
        <rule key="{edcab465-449e-491d-9c18-beebcc498391}" label="1:2000" scalemaxdenom="3000" scalemindenom="1250" symbol="3" />
        <rule key="{0c670928-795b-47e9-8adf-af68eda95c09}" label="1:5000" scalemaxdenom="6000" scalemindenom="3000" symbol="4" />
      </rule>
      <rule filter="&quot;art_txt&quot; IN ('Gebaeude', 'fliessendes Gewaesser', 'Flugplatz', 'stehendes Gewaesser', 'Strasse_Weg', 'Trottoir', 'Verkehrsinsel', 'Wasserbecken')" key="{f4aac74f-4ec3-4726-87de-a1fcac955aea}" label="ausgezogen">
        <rule key="{7b98dee0-bdfd-4a95-85cb-1266371c28b8}" label="1:250" scalemaxdenom="300" scalemindenom="1" symbol="5" />
        <rule key="{b462e755-4cf4-4c8c-aef8-83612e5430e2}" label="1:500" scalemaxdenom="750" scalemindenom="300" symbol="6" />
        <rule key="{374cd542-4086-41f6-95b9-7eb2be60fcc2}" label="1:1000" scalemaxdenom="1250" scalemindenom="750" symbol="7" />
        <rule key="{caa2be31-fb6f-46b1-b287-37733e5ea75b}" label="1:2000" scalemaxdenom="3000" scalemindenom="1250" symbol="8" />
        <rule key="{797e1df1-2ad6-4172-b706-04c49e820361}" label="1:5000" scalemaxdenom="6000" scalemindenom="3000" symbol="9" />
      </rule>
      <rule filter="&quot;art_txt&quot; = 'Gebaeude'" key="{00d2f774-89e4-4bce-9c13-7d7709a47911}" label="Gebaeude" symbol="10" />
      <rule filter="&quot;art_txt&quot; = 'Strasse_Weg'" key="{e9d438a8-8af5-44fe-843a-3041acbd9fdb}" label="Strasse_Weg" symbol="11" />
      <rule filter="&quot;art_txt&quot;  IN ( 'uebrige_befestigte', 'Sportanlage_befestigt','Lagerplatz','Boeschungsbauwerk','Gebaeudeerschliessung','Parkplatz')" key="{458ceabd-3f22-427a-9b13-b79b1ba03948}" label="uebrige_befestigte" scalemaxdenom="6000" scalemindenom="1000" symbol="12" />
      <rule filter="&quot;art_txt&quot; = 'Flugplatz'" key="{0b77290e-65d3-4719-9762-a612957e6950}" label="Flugplatz" scalemaxdenom="6000" symbol="13" />
      <rule filter="&quot;art_txt&quot; = 'Trottoir'" key="{00e98355-cb9d-4f46-b8be-40d35d396b57}" label="Trottoir" scalemaxdenom="6000" symbol="14" />
      <rule filter="&quot;art_txt&quot; = 'stehendes Gewaesser'" key="{e9bfde7d-df40-4a40-b6c1-d6dfd51521ba}" label="Gewaesser_stehendes" scalemaxdenom="6000" scalemindenom="1000" symbol="15" />
      <rule filter="&quot;art_txt&quot; = 'fliessendes Gewaesser'" key="{35e34a34-2a4e-4d09-91ef-ddbdfb1463c1}" label="Gewaesser_fliessendes" scalemaxdenom="6000" scalemindenom="1000" symbol="16" />
      <rule filter="&quot;art_txt&quot; = 'Wasserbecken'" key="{0b4ff262-b207-4e97-b57d-60b34bc7aa90}" label="Wasserbecken" scalemaxdenom="6000" symbol="17" />
      <rule filter="&quot;art_txt&quot; = 'Reben'" key="{e56d45c1-0ae2-44ae-80ea-b4de4490c50e}" label="Reben" scalemaxdenom="6000">
        <rule key="{08581874-8b17-4310-bf90-38f8d23c775b}" label="1:250" scalemaxdenom="300" scalemindenom="300" symbol="18" />
        <rule key="{c05a3e29-1c53-49bf-99aa-1fce26b6f558}" label="1:500" scalemaxdenom="750" scalemindenom="300" symbol="19" />
        <rule key="{c442ef8c-ca4e-477d-994a-e2df07da3200}" label="1:1000" scalemaxdenom="1250" scalemindenom="750" symbol="20" />
        <rule key="{53db1a6b-6805-484a-8a24-4a0763069c9a}" label="1:2000" scalemaxdenom="3000" scalemindenom="1250" symbol="21" />
        <rule key="{369d626a-b25f-4164-8905-d831430a61c0}" label="1:5000" scalemaxdenom="6000" scalemindenom="3000" symbol="22" />
      </rule>
      <rule filter="&quot;art_txt&quot;  = 'Hoch_Flachmoor'" key="{db1926ec-3332-4bd1-b733-6ed501ee8362}" label="Moor" scalemaxdenom="6000">
        <rule key="{72870906-0c4e-429c-b4e1-311192dac096}" label="1:250" scalemaxdenom="300" symbol="23" />
        <rule key="{dffba891-0954-4baa-9d6a-3ca1f45212f2}" label="1:500" scalemaxdenom="750" scalemindenom="300" symbol="24" />
        <rule key="{c36ac685-42f7-4d33-987a-aebd7de6846c}" label="1:1000" scalemaxdenom="1250" scalemindenom="750" symbol="25" />
        <rule key="{9ef1cd79-f8f7-40eb-8826-ae9758f2c691}" label="1:2000" scalemaxdenom="3000" scalemindenom="1250" symbol="26" />
        <rule key="{e2c05324-ed9b-476c-8ee3-258a5d3f0fcf}" label="1:5000" scalemaxdenom="6000" scalemindenom="3000" symbol="27" />
      </rule>
      <rule filter="&quot;art_txt&quot; = 'Schilfguertel'" key="{d1afa824-0771-4029-91bd-7f9d2ab551a3}" label="Schilfguertel" scalemaxdenom="6000">
        <rule key="{4588b59a-bfa3-476e-8b28-d450cd634c00}" label="1:250" scalemaxdenom="300" symbol="28" />
        <rule key="{3c1a6940-4b0f-4a6d-a8e9-67554370cdb5}" label="1:500" scalemaxdenom="750" scalemindenom="300" symbol="29" />
        <rule key="{57817a0d-4136-43a9-9296-b3214817c837}" label="1:1000" scalemaxdenom="1250" scalemindenom="750" symbol="30" />
        <rule key="{972b4572-b7c2-4969-bf16-3d8676ce9816}" label="1:2000" scalemaxdenom="3000" scalemindenom="1250" symbol="31" />
        <rule key="{1b27864a-c9a8-41f3-8ad6-af1359694770}" label="1:5000" scalemaxdenom="6000" scalemindenom="3000" symbol="32" />
      </rule>
      <rule filter="&quot;art_txt&quot; = 'geschlossener_Wald'" key="{c1a022fc-e0b2-4bf8-9b0c-3436c69119cb}" label="geschlossener_Wald" symbol="33" />
      <rule filter="&quot;art_txt&quot;  IN ( 'uebrige_bestockte', 'Parkanlage_bestockt','Hecke')" key="{50bc4589-ca02-4b49-b2f4-6d65aec3d4cc}" label="uebrige_bestockte" scalemaxdenom="6000" scalemindenom="1000">
        <rule key="{f2e049d2-afaa-4637-bf9a-b65f0ffa249a}" label="1:250" scalemaxdenom="300" symbol="34" />
        <rule key="{b1344c22-f54e-4f05-8414-5ed54eccbc8c}" label="1:500" scalemaxdenom="750" scalemindenom="300" symbol="35" />
        <rule key="{87ded360-1d27-42ff-b9ca-b6a21e85b57b}" label="1:1000" scalemaxdenom="1250" scalemindenom="750" symbol="36" />
        <rule key="{8cde9908-2549-4473-9732-dcd74bbc8527}" label="1:2000" scalemaxdenom="3000" scalemindenom="1250" symbol="37" />
        <rule key="{bcda8ca5-e152-4ef1-9128-a0b0fdbf8fde}" label="1:5000" scalemaxdenom="6000" scalemindenom="3000" symbol="38" />
      </rule>
      <rule filter="&quot;art_txt&quot; = 'Fels'" key="{94a7e880-1e92-4831-9c42-0727b30cad39}" label="Fels" scalemaxdenom="6000">
        <rule key="{39931d57-4c6f-4ba0-b7bc-2ab59df33e43}" label="1:250" scalemaxdenom="300" symbol="39" />
        <rule key="{3986d3a2-bc3d-4a5f-9a45-d0c0539932dd}" label="1:500" scalemaxdenom="750" scalemindenom="300" symbol="40" />
        <rule key="{7c2172f1-69cf-4b0d-8e0f-7d8a2132ad83}" label="1:1000" scalemaxdenom="1250" scalemindenom="750" symbol="41" />
        <rule key="{6ca13c49-f2be-4d13-84d7-dabb8cfba4ae}" label="1:2000" scalemaxdenom="3000" scalemindenom="1250" symbol="42" />
        <rule key="{00823811-992e-4bf7-8125-86496cbfa5cd}" label="1:5000" scalemaxdenom="6000" scalemindenom="3000" symbol="43" />
      </rule>
      <rule filter="&quot;art_txt&quot; = 'Geroell_Sand'" key="{34d0c41c-1600-47bf-8543-7b1805187e5f}" label="Geröll_Sand" scalemaxdenom="6000">
        <rule key="{f35ac7b3-3c7f-4633-bc00-11386f98f0f3}" label="1:250" scalemaxdenom="300" symbol="44" />
        <rule key="{0c9aa59b-642e-48a1-b7e9-6700b3c5d61b}" label="1:500" scalemaxdenom="750" scalemindenom="300" symbol="45" />
        <rule key="{0590d993-7147-4e33-b726-538440b86c4f}" label="1:1000" scalemaxdenom="1250" scalemindenom="750" symbol="46" />
        <rule key="{af50c55b-20c4-4227-94bc-cd59f2619baa}" label="1:2000" scalemaxdenom="3000" scalemindenom="1250" symbol="47" />
        <rule key="{dbe92d7b-57ea-4fb9-bc0f-5fb90e001fc5}" label="1:5000" scalemaxdenom="5000" scalemindenom="3000" symbol="48" />
      </rule>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" name="36" type="fill">
        <layer class="PointPatternFill" locked="0" pass="0">
          ...
          <prop k="outline_width_map_unit_scale" v="0,0,0,0,0,0" />
          <prop k="outline_width_unit" v="MM" />
          <symbol alpha="1" clip_to_extent="1" name="@36@0" type="marker">
            <layer class="SimpleMarker" locked="0" pass="0">
              <prop k="angle" v="0" />
              <prop k="color" v="0,0,0,255" />
              <prop k="horizontal_anchor_point" v="1" />
      ...
      <symbol alpha="1" clip_to_extent="1" name="37" type="fill">
        <layer class="PointPatternFill" locked="0" pass="0">
          ...
          <prop k="outline_width_map_unit_scale" v="0,0,0,0,0,0" />
          <prop k="outline_width_unit" v="MM" />
          <symbol alpha="1" clip_to_extent="1" name="@37@0" type="marker">
            <layer class="SimpleMarker" locked="0" pass="0">
              <prop k="angle" v="0" />
              <prop k="color" v="0,0,0,255" />
              <prop k="horizontal_anchor_point" v="1" />
      ...
      <symbol alpha="1" clip_to_extent="1" name="38" type="fill">
        <layer class="PointPatternFill" locked="0" pass="0">
          ...
          <prop k="outline_width_map_unit_scale" v="0,0,0,0,0,0" />
          <prop k="outline_width_unit" v="MM" />
          <symbol alpha="1" clip_to_extent="1" name="@38@0" type="marker">
            <layer class="SimpleMarker" locked="0" pass="0">
              <prop k="angle" v="0" />
              <prop k="color" v="0,0,0,255" />
              <prop k="horizontal_anchor_point" v="1" />
      ...
      <symbol alpha="1" clip_to_extent="1" name="46" type="fill">
        <layer class="SVGFill" locked="0" pass="0">
          ...
          <prop k="svg_outline_width_unit" v="MM" />
          <prop k="width" v="2" />
          <symbol alpha="1" clip_to_extent="1" name="@46@0" type="line">
            <layer class="SimpleLine" locked="0" pass="0">
              <prop k="capstyle" v="square" />
              <prop k="customdash" v="5;2" />
              <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0" />
      ...
      <symbol alpha="1" clip_to_extent="1" name="47" type="fill">
        <layer class="SVGFill" locked="0" pass="0">
          ...
          <prop k="svg_outline_width_unit" v="MM" />
          <prop k="width" v="1.4" />
          <symbol alpha="1" clip_to_extent="1" name="@47@0" type="line">
            <layer class="SimpleLine" locked="0" pass="0">
              <prop k="capstyle" v="square" />
              <prop k="customdash" v="5;2" />
              <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0" />
      ...
      <symbol alpha="1" clip_to_extent="1" name="48" type="fill">
        <layer class="SVGFill" locked="0" pass="0">
          ...
          <prop k="svg_outline_width_unit" v="MM" />
          <prop k="width" v="1.5" />
          <symbol alpha="1" clip_to_extent="1" name="@48@0" type="line">
            <layer class="SimpleLine" locked="0" pass="0">
              <prop k="capstyle" v="square" />
              <prop k="customdash" v="5;2" />
              <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0" />
