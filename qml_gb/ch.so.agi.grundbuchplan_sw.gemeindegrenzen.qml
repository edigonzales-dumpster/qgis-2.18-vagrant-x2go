...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="1" maximumScale="5000" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{c84df01c-5674-464e-9ede-45e48c4fc911}">
      <rule key="{ae14952d-ec07-43bc-a111-1f91b6ceab01}">
        <rule scalemaxdenom="300" key="{17db32b9-3550-49b2-be10-58276d0e5989}" symbol="0" scalemindenom="1" label="1:250"/>
        <rule scalemaxdenom="750" key="{2e1e46f6-86e1-41e6-bbc0-d17107662b38}" symbol="1" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{47585e9a-25f9-45ea-8359-f244ce6f83dd}" symbol="2" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{80758f98-1c8f-4187-8299-1207e3bcd137}" symbol="3" scalemindenom="1250" label="1:2000"/>
        <rule scalemaxdenom="6000" key="{4a64418b-c87c-4049-8135-b8e6b89e90ff}" symbol="4" scalemindenom="3000" label="1:5000"/>
      </rule>
    </rules>
    <symbols>
