...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="1" maximumScale="5000" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{2b950700-43b9-4c50-8ea9-252133f1b21f}">
      <rule filter="&quot;art_txt&quot;  !=   'Liegenschaft' " key="{5936f70e-3b2e-4dd3-a1ab-846ed427fb08}" label="SelbstRecht">
        <rule scalemaxdenom="300" key="{afa639fd-ab25-4084-a567-2653d8277ad6}" symbol="0" scalemindenom="300" label="1:250"/>
        <rule scalemaxdenom="750" key="{4c35292b-518e-42f4-9350-89dcb693f65e}" symbol="1" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{24d64013-48a3-4007-99fb-a932908662a2}" symbol="2" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{ea1d0d7b-1cbd-4a04-98b1-22290ed2c3ce}" symbol="3" scalemindenom="1250" label="1:2000"/>
        <rule scalemaxdenom="6000" key="{7b2957b4-adf1-4116-b5c3-5a9053ff6c0a}" symbol="4" scalemindenom="3000" label="1:5000"/>
      </rule>
    </rules>
    <symbols>
