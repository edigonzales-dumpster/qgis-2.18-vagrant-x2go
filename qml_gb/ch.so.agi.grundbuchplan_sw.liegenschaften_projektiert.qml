...
<qgis version="2.18.19" simplifyAlgorithm="0" minimumScale="1" maximumScale="5000" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{eba6959b-5133-45e1-b23c-b6f8fe725674}">
      <rule filter=" &quot;art_txt&quot;  =  'Liegenschaft' " key="{bd6ac8b0-4932-4cf1-a75a-1ac3a074d206}">
        <rule scalemaxdenom="300" key="{ce7f4c85-5458-43ae-b109-e6d26377d750}" symbol="0" scalemindenom="1" label="1:250"/>
        <rule scalemaxdenom="750" key="{39cb48ed-d448-44a6-97ff-d536b0be6d5e}" symbol="1" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{1ce84bef-4df4-4348-954a-e854d3353f49}" symbol="2" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{91b8b712-2d1b-4ffa-945d-fa2b7eeae86e}" symbol="3" scalemindenom="1250" label="1:2000"/>
        <rule scalemaxdenom="6000" key="{26bb43b3-e13a-41cf-84ae-5aa4d86e1d5c}" symbol="4" scalemindenom="3000" label="1:5000"/>
      </rule>
    </rules>
    <symbols>
