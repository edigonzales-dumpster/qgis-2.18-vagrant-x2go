...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="25000" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{37f1b184-d381-4c01-ace6-b8c713f0d504}">
      ...
      <rule filter="&quot;art_txt&quot; = 'Reben'" key="{97a6cc4a-b237-4738-9baf-37d1e7fe4acd}" label="Reben">
        <rule scalemaxdenom="300" key="{5908c165-744f-437a-9a0c-8f1f39c7a456}" symbol="10" scalemindenom="1" label="1:250"/>
        <rule scalemaxdenom="750" key="{7c521c1e-b96d-4c1d-8af1-8936036e7003}" symbol="11" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{4631a69d-fad8-4ad9-9a2d-6d26a80e7a10}" symbol="12" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{2437643d-0f9e-4fb4-9b6f-89ddb2287582}" symbol="13" scalemindenom="1250" label="1:2000"/>
        <rule scalemaxdenom="6000" key="{40cae965-c4d1-4761-a6a6-650365ec447b}" symbol="14" scalemindenom="3000" label="1:5000"/>
      </rule>
      <rule filter="&quot;art_txt&quot; = 'Hoch_Flachmoor'" key="{f60e41d6-c87e-497d-8d49-cffb167ad507}" label="Moor">
        <rule scalemaxdenom="300" key="{7405ae18-2c19-458e-8fb2-15c84d13f992}" symbol="15" scalemindenom="300" label="1:250"/>
        <rule scalemaxdenom="750" key="{bbd09fb4-74b2-4c3b-860d-e69e51ed352f}" symbol="16" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{cc48d9fc-4ca1-4116-8fb2-5a14efc47600}" symbol="17" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{36e2c486-09ef-4b82-b1fd-f07c9017f977}" symbol="18" scalemindenom="1250" label="1:2000"/>
        <rule scalemaxdenom="6000" key="{cecf5eae-91f4-455d-adac-cf23c3970f07}" symbol="19" scalemindenom="3000" label="1:5000"/>
      </rule>
      <rule filter="&quot;art_txt&quot; = 'Schilfguertel'" key="{f252172c-4c21-424a-8333-7d68bd0b5dc3}" label="Schilfguertel">
        <rule scalemaxdenom="300" key="{7355d8e0-349e-4c98-a23f-a8e6ac2c9f7a}" symbol="20" scalemindenom="300" label="1:250"/>
        <rule scalemaxdenom="750" key="{cb3e80b9-b191-4106-b189-e6aead82b489}" symbol="21" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{6194e90b-831f-4805-9cc4-4366a3fb7d79}" symbol="22" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{1a7511a0-b860-44d6-a8e6-9a6aad7fb6da}" symbol="23" scalemindenom="1250" label="1:2000"/>
        <rule scalemaxdenom="6000" key="{2ca2c8eb-5e3d-479d-af35-bd8ca66b473b}" symbol="24" scalemindenom="3000" label="1:5000"/>
      </rule>
      <rule filter="&quot;art_txt&quot; = 'geschlossener_Wald'" key="{9913eb4f-d55e-495a-981f-888a10fe1f13}" label="geschlossener_Wald">
        <rule scalemaxdenom="300" key="{c78f453d-6d09-4a86-89e1-02aa26ea6a6c}" symbol="25" label="1:250"/>
        <rule scalemaxdenom="750" key="{fdc6474e-22af-4944-a793-36576d07a4e8}" symbol="26" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{6d64095d-1924-4fc1-8d0c-3ecc897c51e0}" symbol="27" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{774b6daa-9574-4f8e-a508-b3a1679385fd}" symbol="28" scalemindenom="1250" label="1:2000"/>
        <rule scalemaxdenom="25000" key="{67d46429-b05b-4b9a-a70d-43469826d3f1}" symbol="29" scalemindenom="3000" label="1:5000"/>
      </rule>
      <rule filter="&quot;art_txt&quot; = 'uebrige_bestockte'" key="{d4a04290-3cb3-4261-b7f5-da6370ebbcd7}" label="uebrige_bestockte">
        <rule scalemaxdenom="300" key="{4203e22e-d88f-4556-85df-2747e11a5ac9}" symbol="30" label="1:250"/>
        <rule scalemaxdenom="750" key="{9af503b1-42c4-4107-9bb4-8bdbed73454a}" symbol="31" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{4815bcf4-9434-4ece-853b-74260fba177d}" symbol="32" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{075066e9-1d78-42b6-acbc-0b732e2cda79}" symbol="33" scalemindenom="1250" label="1:2000"/>
        <rule scalemaxdenom="6000" key="{b5153922-1066-41bf-8f2f-d64019cd49ee}" symbol="34" scalemindenom="3000" label="1:5000"/>
      </rule>
      <rule filter="&quot;art_txt&quot; = 'Fels'" key="{d70d2de9-8ac9-4c75-ae82-803e15aa9213}" label="Fels">
        <rule scalemaxdenom="300" key="{881f94e0-cb9e-4f2b-8ae0-92d4acc08ebc}" symbol="35" scalemindenom="300" label="1:250"/>
        <rule scalemaxdenom="750" key="{08b4d5a3-4eb0-405d-b992-56fc3d79c645}" symbol="36" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{4c72462f-3e3e-45e2-988c-00ec524ad0a3}" symbol="37" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{2dab7f8d-97c6-4ae1-93c7-ed33dcd6049d}" symbol="38" scalemindenom="1250" label="1:2000"/>
        <rule scalemaxdenom="6000" key="{d363a686-faf1-4e41-823b-e31189c2e9ba}" symbol="39" scalemindenom="3000" label="1:5000"/>
      </rule>
      <rule filter="&quot;art_txt&quot; = 'Geroell_Sand'" key="{c2c3bb17-6156-4ed4-8e54-e83fa387630d}" label="Geröll_Sand">
        <rule scalemaxdenom="300" key="{e17f1afc-63c8-47d6-8bc1-a2260437261b}" symbol="40" scalemindenom="300" label="1:250"/>
        <rule scalemaxdenom="750" key="{126bbc3b-bb5e-41be-ac41-b019c633ba44}" symbol="41" scalemindenom="300" label="1:500"/>
        <rule scalemaxdenom="1250" key="{1e1bf477-eec1-4386-b1bc-49aa7188ba4d}" symbol="42" scalemindenom="750" label="1:1000"/>
        <rule scalemaxdenom="3000" key="{694058c1-6313-4590-8987-d93028f34b31}" symbol="43" scalemindenom="1250" label="1:2000"/>
        <rule scalemaxdenom="5000" key="{180de699-0b80-4362-87f8-9cd7acee4408}" symbol="44" scalemindenom="3000" label="1:5000"/>
      </rule>
      <rule scalemaxdenom="25000" filter="&quot;art_txt&quot; IN ('Gebaeude', 'Flugplatz', 'stehendes Gewaesser', 'Strasse_Weg')" key="{7d127a23-8aa6-4241-b73c-6dd2fd82a64a}" symbol="45" scalemindenom="6000" label="ausgezogen_reduziert"/>
    </rules>
    <symbols>
